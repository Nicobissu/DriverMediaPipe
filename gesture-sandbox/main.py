"""Gesture Driver — webcam hand gesture control for Windows."""
...
from config import CAM_X_MIN, CAM_X_MAX, CAM_Y_MIN, CAM_Y_MAX
...
class GestureDriver:
    ...
    def _draw_hud(self, frame, right, left):
        ...
        # Controls legend
        legend = [
            "R: Idx+Mid=Cursor  Fist=Click  Pinch=DblClick",
            "R: Idx+Mid+Ring=Scroll  Index=Standby",
            "L: Pinch=Minimize  Idx+Pinky=Close  Fist=TaskView",
        ]
        for i, line in enumerate(legend):
            cv2.putText(frame, line, (10, h - 50 + i * 18),
